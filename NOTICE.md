...
`eval-aime2024` packages an evaluation from **inspect_evals**.

- **Upstream:** https://github.com/UKGovernmentBEIS/inspect_evals (`src/inspect_evals/aime2024`)
...
- `huggingface`: `Maxwell-Jia/AIME_2024`
