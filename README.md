...
2024 AIME - a prestigious high school mathematics competition.

## At a glance

| | |
|---|---|
| Upstream | [`src/inspect_evals/aime2024`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/aime2024) |
| Group | Mathematics |
| Total samples | 30 |
...
- `huggingface` — `Maxwell-Jia/AIME_2024` (pinned)
